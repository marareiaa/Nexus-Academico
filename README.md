# Nexus Acadêmico
Sistema de Gestão de Eventos e Ligas Acadêmicas (Foco no ODS 8 - Trabalho Decente e Crescimento Econômico)  Arquitetura desenhada para gerenciar a organização de eventos, workshops ou consultorias juniores, facilitando o controle de participantes e a emissão de dados para certificados.
...
O diagrama apresenta a estrutura do banco de dados e os principais elementos que compõem a aplicação, incluindo entidades, atributos e relacionamentos entre usuários, eventos, inscrições, presenças e certificados.

[📄 Visualizar o Diagrama em PDF](docs/diagrama-entidade-relacionamento.pdf)
